...
: ${AMENT_CURRENT_PREFIX:="/home/zme/self_project/rebotArm_mujoco/install/robot_motion"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_motion/environment/library_path.sh"
