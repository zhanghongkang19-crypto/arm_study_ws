...
bool robot_msgs__msg__arm_position_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_msgs.msg._arm_position_cmd.ArmPositionCmd", full_classname_dest, 47) == 0);
  }
  robot_msgs__msg__ArmPositionCmd * ros_message = _ros_message;
  {  // position
...
{
  /* NOTE(esteve): Call constructor of ArmPositionCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_msgs.msg._arm_position_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArmPositionCmd");
